...
const clientRoot = path.join(repositoryRoot, ".generated/m7/client");
...
if (!fs.existsSync(indexPath))
  throw new Error("GDevelop did not create the M7 client index.html.");
...
console.log(`Exported M7 client fixture: ${indexPath}`);
