...
const clientRoot = path.join(repositoryRoot, ".generated/m5/client");
...
if (!fs.existsSync(indexPath))
  throw new Error("GDevelop did not create the M5 client index.html.");
...
console.log(`Exported M5 client fixture: ${indexPath}`);
